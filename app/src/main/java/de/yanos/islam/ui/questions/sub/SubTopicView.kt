...
fun SubTopicsScreen(
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        PrimaryLottie(modifier = modifier.height(180.dp), resId = R.raw.lottie_girl_thinking)
        Text(modifier = modifier, text = vm.topicName.collectAsState(initial = "").value ?: "", style = titleLarge())
